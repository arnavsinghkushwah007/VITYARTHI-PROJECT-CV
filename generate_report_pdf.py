...
def build_pdf(filename="docs/Project_Report.pdf"):
    ...
    cover_meta = [
        ...
        [Paragraph("<strong>Candidate Name:</strong>", table_cell_style), Paragraph("Student Candidate", table_cell_style)],
        [Paragraph("<strong>Registration No:</strong>", table_cell_style), Paragraph("2XABCXXXX", table_cell_style)],
